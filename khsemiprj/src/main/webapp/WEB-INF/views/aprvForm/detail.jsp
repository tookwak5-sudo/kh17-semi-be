...
<div class="container w-800 mt-50 mb-50">
            ...
            <tbody>
            	<tr>
                    ...
                    <td style="background-color: #556b82; color: white; text-align: center; padding: 10px; border: 1px solid #ccc;">
                     ${aprvFormSelectVO.formNo}
                    </td>
                </tr>
                <tr>
                    <th style="width: 30%; background-color: #f8f9fa; text-align: center; padding: 10px; border: 1px solid #ccc;">양식번호</th>
                    <td style="background-color: #556b82; color: white; text-align: center; padding: 10px; border: 1px solid #ccc;">
                     ${aprvFormSelectVO.headType}
                    </td>
                </tr>
                <tr>
                    <th style="width: 30%; background-color: #f8f9fa; text-align: center; padding: 10px; border: 1px solid #ccc;">양식분류</th>
                    <td style="background-color: #556b82; color: white; text-align: center; padding: 10px; border: 1px solid #ccc;">
                        <c:if test="${aprvFormSelectVO.headName != null}">${aprvFormSelectVO.headName}</c:if>
    ...
    <div class="cell center">
        <c:if test="${sessionScope.loginId != null}">
            <a href="./edit?formNo=${aprvFormSelectVO.formNo}" class="btn" style="background-color: #556b82; color: white; border: none; padding: 10px 20px; margin-right: 5px;">수정하기</a>
            
            <a href="./delete?formNo=${aprvFormSelectVO.formNo}" class="btn" style="background-color: #ff1744; color: white; border: none; padding: 10px 20px; margin-right: 5px;" onclick="return confirm('정말 이 결재 양식을 삭제하시겠습니까?');">삭제하기</a>
        </c:if>
