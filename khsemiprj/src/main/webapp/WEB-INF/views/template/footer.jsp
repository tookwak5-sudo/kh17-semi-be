...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			...
			<c:choose>
				...
				<c:otherwise>
					<!-- 비동기용 알림 -->
					<div id="div-alarm" style="position: absolute;top: 590px;right: 20px;display:none;">
				        <a id="send-alarm" class="btn btn-positive btn-slide-hidden" onclick="$(this).parent().hide();" >알림</a>
				    </div>
				</c:otherwise>
	    	</c:choose>
        </div>
