...
<script type="text/template" id="cert-template">
        <div class="cert-wrapper flex-area mt-10" style="flex-wrap: wrap;">
            ...
            <div class="cert-message w-100 mt-5 font-small"></div>
        </div>
     </script>
...
<div class="cell center">
	<c:if test="${param.error != null}">
		<span style="color: red; font-weight: bold;">입력하신 정보가 없습니다.</span>
	</c:if>
</div>
