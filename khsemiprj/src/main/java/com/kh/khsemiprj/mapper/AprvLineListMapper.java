...
@Component
public class AprvLineListMapper implements RowMapper<AprvLineListVO> {
	@Override
	public AprvLineListVO mapRow(ResultSet rs, int rowNum) throws SQLException {
		return AprvLineListVO.builder()
